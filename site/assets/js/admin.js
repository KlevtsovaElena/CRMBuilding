...
function apply(section_name, filters) {
    ...
    if(searchQuery.trim()) {
        ...
        if (section_name == 'admin-vendors') {
            ...
            //вносим изменение в адресную строку страницы
            history.replaceState(history.length, null, 'vendor-customers.php?limit=all&search=first_name:' + searchQuery.trim() + filters);

            document.location.href = mainUrl + '/pages/vendor-customers.php?limit=all&search=first_name:' +  searchQuery.trim() + filters;
        ...
        if (section_name == 'admin-vendors') {
            ...
            history.replaceState(history.length, null, 'vendor-customers.php?' + filters);

            // document.location.href = mainUrl + '/pages/admin-customers.php?limit=' + limit.value + filters;
            document.location.href = mainUrl + '/pages/vendor-customers.php?' + filters;
