...
<?php include('./../components/header.php'); ?>   
    ...
    ?>
        ...
        <p class="page-title" data-name="<?= $keyName; ?>">Категории</p>
        ...
        <section class="form-filters">
            ...
            <div class="d-iblock add-block">
                ...
                <button class="btn btn-ok d-iblock" onclick="addNew('categories')">+ Добавить</button>
            </div>
            <br>
            <div class="form-elements-container">
                ...
                <button onclick="apply('admin-categories', '')" class="btn btn-ok d-iblock">Применить</button>
        ...
        <section class="orders">
            <table>
                ...
                <tbody class="list-products__body" id="new-order-products">
                    ...
                    if(isset($_GET['search'])) {
                        $dataJson = file_get_contents($nginxUrl . '/api/categories.php?search=' . $_GET['search']);
                        $data = json_decode($dataJson, true);
