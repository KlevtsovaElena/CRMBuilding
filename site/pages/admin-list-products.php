    ...
    <template id="template-body-table">
        ...
        <tr role="row" class="list-products__row" product-id="${id}">
            ...
            <td><div class="change-price" title="Изменить цены"  data-price-num="${price}">${price}</div>
                <input type="hidden" name="price" class="change-price-input" placeholder="${price}" value="" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
            </td>
            <td>
                <div class="change-price" title="Изменить цены" data-price-num="${max_price}">${max_price}</div>
                <input type="hidden" name="max_price" class="change-price-input" placeholder="${max_price}" value="" onkeypress='return event.charCode >= 48 && event.charCode <= 57'>
