...
<?php include('./../components/header.php'); ?>   
    ...
    ?>
        ...
        <!-- далее отрисовываем всю страницу Городов -->
        <p class="page-title" data-name="<?= $keyName; ?>">Города</p>
        ...
        <section class="form-filters">
            ...
            <div class="d-iblock add-block">
                ...
                <button class="btn btn-ok d-iblock" onclick="addNew('cities')">+ Добавить</button>
            </div>
            <br>
            <div class="form-elements-container">
                ...
                <button onclick="apply('admin-cities', '')" class="btn btn-ok d-iblock">Применить</button>
        ...
        <section class="orders">
            <table>
                ...
                <tbody class="list-products__body" id="new-order-products">
                    ...
                    if(isset($_GET['search'])) {
                        $dataJson = file_get_contents($nginxUrl . '/api/cities.php?search=' . $_GET['search']);
                        $data = json_decode($dataJson, true);
